...
exports.canceledLeaveRequest = async (req, res) => {
  console.log(`
--------------------------------------------------
  User : ${req.decoded._id}
  API  : canceled Leave Request Pending List
  router.get('/canceled-leave-request', approvalMngmtCtrl.canceledLeaveRequest);
